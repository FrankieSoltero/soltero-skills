---
name: lean-tdd
description: Use when implementing any feature or bugfix, before writing implementation code. No production code without a test you watched fail; code written before its test is deleted (stashing it "as reference" counts as keeping it); a test that passes on its first run is distrusted until proven able to fail.
---
