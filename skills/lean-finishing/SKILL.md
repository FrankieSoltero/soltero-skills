---
name: lean-finishing
description: Use when implementation is complete and a feature branch needs integrating. Runs the full suite fresh on the exact tree, then offers merge locally / push + PR / keep unless the user explicitly delegated the choice; discard only on the typed word `discard`; protected branches go through a PR, never a force-push.
---
