...
4. **Re-convene** the council on the edited PRD (round N+1). Maximum 3 rounds; if still
   BLOCKED, report exactly what's blocking and stop — the PRD goes back to
   soltero-skills:writing-prds, not onward to design.
