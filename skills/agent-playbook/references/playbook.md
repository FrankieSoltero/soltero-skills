...
<!-- markdownlint-disable-next-line MD001 -- template sample of an entry heading, not document structure -->
...
- **Tier:** Watch (added 2026-07-09)
- **Sources:** [Cursor: Best practices](https://cursor.com/blog/agent-best-practices)
- **Detail:** e.g. 'write a test for auth.ts covering the logout edge case, using patterns in **tests**/, avoiding mocks' vs 'add tests for auth.ts'. Well-worn prompting hygiene; asserted, not benchmarked, for this exact formulation.
