...
task is /tmp/te-haiku-scenario-3-without/.claude — the transcripts are under its projects/ folder; pass
/tmp/te-haiku-scenario-3-without wherever a tool wants a home directory. Do not read or write anything outside
/tmp/te-haiku-scenario-3-without and the skills directory.
...
Write /tmp/te-haiku-scenario-3-without/audit-report.md with the ranked findings and the numbers behind each,
