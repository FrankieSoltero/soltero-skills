...
task is /tmp/te-sonnet-scenario-3-with/.claude — the transcripts are under its projects/ folder; pass
/tmp/te-sonnet-scenario-3-with wherever a tool wants a home directory. Do not read or write anything outside
/tmp/te-sonnet-scenario-3-with and the skills directory.
...
Write /tmp/te-sonnet-scenario-3-with/audit-report.md with the ranked findings and the numbers behind each,
