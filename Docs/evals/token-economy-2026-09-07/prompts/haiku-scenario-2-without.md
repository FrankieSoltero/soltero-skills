...
directory for this task is /tmp/te-haiku-scenario-2-without/.claude — treat it exactly as you would ~/.claude
and pass /tmp/te-haiku-scenario-2-without wherever a tool wants a home directory. Do not read or write anything
outside /tmp/te-haiku-scenario-2-without and the skills directory.
...
Apply the setup under /tmp/te-haiku-scenario-2-without/.claude. In your final message list every file you
