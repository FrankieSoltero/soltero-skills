...
directory for this task is /tmp/te-sonnet-scenario-2-with/.claude — treat it exactly as you would ~/.claude
and pass /tmp/te-sonnet-scenario-2-with wherever a tool wants a home directory. Do not read or write anything
outside /tmp/te-sonnet-scenario-2-with and the skills directory.
...
Apply the setup under /tmp/te-sonnet-scenario-2-with/.claude. In your final message list every file you
