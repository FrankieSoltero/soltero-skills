...
Your working directory is /tmp/acme-ledger-ab-sonnet-s2-with. Your user-scope config directory for this task
is /tmp/acme-home-ab-sonnet-s2-with/.claude — treat it exactly as ~/.claude (pass /tmp/acme-home-ab-sonnet-s2-with wherever a
tool wants your home directory). Do not read or write anything
outside /tmp/acme-ledger-ab-sonnet-s2-with and /tmp/acme-home-ab-sonnet-s2-with (plus the skills directory if one was named
to you).
