...
Your working directory is /tmp/acme-ledger-ab-sonnet-canary-without. Your user-scope config directory for this
task is /tmp/acme-home-ab-sonnet-canary-without/.claude — treat it exactly as ~/.claude (pass /tmp/acme-home-ab-sonnet-canary-without
