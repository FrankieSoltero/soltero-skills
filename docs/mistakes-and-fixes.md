...
- **Regression test:** the two new symlink tests for preflight.mjs/check-output.mjs, plus: grep -rn 'import.meta.url === `file://' skills/ tools/ returns zero files outside an isMain() implementation
