...
- **Scope / non-goals:** Convene a 6-grader council via the bundled Workflow
  ...
  weighted aggregate in script. Gate: overall ≥95 AND every dimension ≥80, else verdict
  BLOCKED. Report to `docs/prd-reviews/YYYY-MM-DD-<topic>-review.md`. Fix loop: apply
